...
class _MyAppState extends State<MyApp> {
    ...
    try {
      ...
      if (supportAltIcons) {
        ...
        _scaffoldKey.currentState
          ..hideCurrentSnackBar()
          ..showSnackBar(SnackBar(content: Text("App icon changed successful")));
  ...
  Future<void> _setBatchNumber(String val) async {
    ...
    try {
      ...
      _scaffoldKey.currentState
        ..hideCurrentSnackBar()
        ..showSnackBar(SnackBar(content: Text("Batch number changed successful")));
    } catch (e) {
      _scaffoldKey.currentState
        ..hideCurrentSnackBar()
        ..showSnackBar(SnackBar(content: Text("Failed to change batch number")));
      debugPrint(e.toString());
    }
    setState(() {
      loading = false;
